...
Souhlasíš, ale poprosíš je alespoň o malinkou nápovědu. Prý je to něco mezi 1 až 10""")
    ...
    def hadej(self):
        ...
        if self.pocet_pokusu == 0 and self.odpoved != self.cislo:
            print()
            print(
                f"Neuhodl jsi - správný výsledek byl {self.cislo}. Děti se ti smějí. Dáš jim svačinu a zahanbeně odcházíš pryč")
            for z in range(5):
                hrdina.jez()
...
class Ukol_2:
    ...
    hadanky = {
        "cas": "Pohltí: ptáky, stromy, květiny. Kouše ocel, drtí tvrdé kameny na mouku, zabíjí krále a ničí města.",
    ...
    def hadej_hadanku(self):
        ...
        if self.spravna_odpoved > 1:
            ...
            print(
                "Neporazil jsi mě, ale nic si z toho nedelěj. Nejsi první, ani poslední. Nech tu celý tlumok a teď táhni, odkud jsi přišel")
...
class Ukol_3:  # 3 . úkol s vojákem a hra kámen nůžky papír
    ...
    def kamen_nuzky_papir(self):
        ...
        """
        volba = zadani_hodnot(
            "Chceš si s ním zahrát ? zvol 1 Chceš raději odejít? zvol 2 Chceš ho praštít, vzít štít a utéct? zvol 3\n",
            1, 3)
        if volba == 1:
        ...
        if volba == 3:
            ...
            if nahoda == 1 or 2:
                ...
                print(
                    "Dříve než si voják uvědomil co se děje, tak jsi ho prašil jílcem meče a i se štítem jsi utekl pryč.")
...
class Ukol_4:  # 4 ukol na hádání hesla do věže
    ...
    def __init__(self, obtiznost_heslo):
        ...
        """
        self.slova = ["vytrvalost", "odvaha", "statecnost", "hrdina", "slava", "obetavost", "prsten", "udatnost",
                      "respekt", "programator"]
    ...
    def zadej_heslo(self):
        ...
        while "_" in skyte_slovo:  # program pobeží, dokud sryté slovo, bude obsahovat pomlčku
            ...
            for index in range(0,
                               len(skyte_slovo)):  # program projede skyrté slovo a pokud obsahuje zadané písmeno, tak ho doplní místo pomlčky do skrytého slova
...
class Ukol_7:
    ...
    def __str__(self):
        ...
        Chlapec má velikou radost a slibuje ti něco z tátovi výavy, ale musíte to stihnout dříve, 
    ...
    def pocitej(self):
        ...
        if spravna_odpoved == vyhra and zbyly_cas >= 0:
            ...
            print("Chlapec má velikou radost a ptá se tě, jestli chceš otvuc štít, nebo meč")
